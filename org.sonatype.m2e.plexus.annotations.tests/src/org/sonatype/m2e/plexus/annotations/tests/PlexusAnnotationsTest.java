package org.sonatype.m2e.plexus.annotations.tests;
...
public class PlexusAnnotationsTest
    extends AbstractMavenProjectTestCase
{
        ...
        throws Exception
    {
        ...
        copyContent( project, "src/main/java/simple/p001/P001SimpleImpl.java-changed",
                     "src/main/java/simple/p001/P001SimpleImpl.java" );
        project.build( IncrementalProjectBuilder.INCREMENTAL_BUILD, monitor );
    ...
    public void testIntraProjectDependencies()
        throws Exception
    {
        ...
        IFile metadata = project.getFile( "target/classes/META-INF/plexus/components.xml" );
        ComponentDescriptor comp02 =
            getComponentDescriptor( readComponentSet( metadata ), "simple.p002.P002Simple02Impl" );
        assertRequirement( comp02, "r01", "" );
        IFile testMetadata = project.getFile( "target/test-classes/META-INF/plexus/components.xml" );
        ComponentDescriptor compTest =
            getComponentDescriptor( readComponentSet( testMetadata ), "simple.p002.test.P002SimpleTestImpl" );
        assertRequirement( compTest, "r01", "" );

        // change parent class, check changes are reflected in subclass components
        copyContent( project, "src/main/java/simple/p002/P002Simple01Impl.java-changed",
                     "src/main/java/simple/p002/P002Simple01Impl.java" );
        project.build( IncrementalProjectBuilder.INCREMENTAL_BUILD, monitor );
    ...
    public void testInterProjectDependencies()
        throws Exception
    {
        ...
        ComponentDescriptor comp02 =
            getComponentDescriptor( readComponentSet( metadata ), "simple.p003.P003Simple01Impl" );
        assertRequirement( comp02, "r01", "" );
        IFile testMetadata = project03.getFile( "target/test-classes/META-INF/plexus/components.xml" );
        ComponentDescriptor compTest =
            getComponentDescriptor( readComponentSet( testMetadata ), "simple.p003.test.P003SimpleTestImpl" );
        assertRequirement( compTest, "r01", "" );

        // change parent class, check changes are reflected in subclass components
        copyContent( project02, "src/main/java/simple/p002/P002Simple01Impl.java-changed",
                     "src/main/java/simple/p002/P002Simple01Impl.java" );
    ...
    public void testCustomMetadataMerge()
        throws Exception
    {
    ...
    public void testConstantFieldValues()
        throws Exception
    {
    ...
    public void testIndirectConstantHint()
        throws Exception
    {
        IProject project =
            importProject( "projects/MNGECLIPSE-2287_indirectConstantHint/pom.xml", new ResolverConfiguration() );
        waitForJobsToComplete();
    ...
    private void assertMetadata( IFile metadata )
        throws IOException, CoreException, PlexusConfigurationException
    {
    ...
    private ComponentSetDescriptor readComponentSet( IFile metadata )
        throws IOException, CoreException, PlexusConfigurationException
    {
        ...
        try
        {
            PlexusConfiguration plexusConfiguration =
                DefaultComponentDescriptorReader.buildConfiguration( "test resource", reader );
